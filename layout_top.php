...
?>
<style>
/* Hilangkan warna latar belakang hitam pada tombol pagination */
.dataTables_wrapper .dataTables_paginate .paginate_button {
    background-color: transparent !important;
    border: none !important;
    color: #337ab7 !important; /* warna teks biru, bisa diganti */
}

/* Saat tombol diklik (active atau current), tetap transparan */
.dataTables_wrapper .dataTables_paginate .paginate_button.current,
.dataTables_wrapper .dataTables_paginate .paginate_button:active {
    background-color: transparent !important;
    box-shadow: none !important;
    color: #fff !important; /* warna teks tombol aktif */
    background: #337ab7 !important; /* warna latar belakang tombol aktif (bisa diganti) */
    border-radius: 4px;
}

/* Hilangkan bayangan hover jika tidak diinginkan */
...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; background-color:rgba(0, 0, 0, 0.86); font-family: Roboto; position: fixed; top: 0; left: 0; width: 100%;">
